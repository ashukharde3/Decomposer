...
/* 
 * File:   dependency_test_runner.cc
 * Author: ashu
 * 
 * Created on Jul 16, 2016, 5:36:42 PM
 */
...
int other() {
    CppUnit::TextTestResult controller;
    ...
    CppUnit::TextOutputter outputter(&result, CPPUNIT_NS::stdCOut());
    outputter.write();
